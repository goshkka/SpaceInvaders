...
#
#  File     top_level_ports_wave.tcl (Mon Nov 25 20:54:49 2013)
#
...
wave add $tbpath${ps}ps2_keyboard_0_ps2c_pin -into $id 
wave add $tbpath${ps}ps2_keyboard_0_ps2d_pin -into $id 
